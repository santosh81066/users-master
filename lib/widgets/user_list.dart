...
import 'package:users/providers/notificationprovider.dart';
import 'package:users/providers/userprofiledatanotifier.dart';
import 'package:users/providers/zegeocloudprovider.dart';
import 'package:users/widgets/statusindicator.dart';
          ...
          child: Button(
              ...
              onTap: () {
                Navigator.of(context).pushNamed('profileDetails',
                    arguments: {'url': url, 'amount': amt, 'cattype': cattype});
                // handleCallTap(
